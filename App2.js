  ...
  return (
    <View style={styles.container}>
      ...
      >
       ...
       {visibleRegion && visibleRegion.latitudeDelta < 0.03 && stops
             .filter(s =>
              s.lat < visibleRegion.latitude + visibleRegion.latitudeDelta / 2 &&
              s.lat > visibleRegion.latitude - visibleRegion.latitudeDelta / 2 &&
              s.lon < visibleRegion.longitude + visibleRegion.longitudeDelta / 2 &&
              s.lon > visibleRegion.longitude - visibleRegion.longitudeDelta / 2
            )
       .map(s => (
  <Marker
